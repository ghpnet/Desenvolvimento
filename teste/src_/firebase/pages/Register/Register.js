...
const Register = () => {
    ...
    return (
        <div>
            <h3> Cadastre-se </h3>
            <p>Crie seu usuário e fique por dentro de tudo o que rola no mundo Fotovoltaico</p>
            <form onSubmit={handleSubmitMarielen}>
                ...
                <label>
                    ...
                    {!loading && <button className='botaoConf'>Cadastrar</button>}
                    {!loading && <button className='botaoConf' disabled>Aguarde</button>}
